                ...
                <?php foreach ($aparelhos as $aparelho): ?>
                    <div class="card my-3 bg-card m-2 card-exibicao p-0">
                        ...
                        <div class="d-flex justify-content-center w-100 py-2">
                            <a href="/<?= esc(($aparelho['TIPO']) == 'A') ? 'aparelho' : 'gerador' ?>/editar/<?= esc($aparelho['ID']) ?>" class="text-decoration-none btn-card bg-alterar-outline d-block">
                                <span class="material-icons rounded">edit</span>
                            </a>
                            <a href="/<?= esc(($aparelho['TIPO']) == 'A') ? 'aparelho' : 'gerador' ?>/excluir/<?= esc($aparelho['ID']) ?>" class="text-decoration-none btn-card bg-perigo-outline d-block">
