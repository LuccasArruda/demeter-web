...
<body class="bg-body-secondary">
    ...
    <div class="cadastro-ambiente bg-light rounded-5 position-absolute top-50 start-50 translate-middle">
        ...
        <form action="<?= site_url('aparelho/editar/salvar/' . $aparelho['ID']) ?>" method="post" enctype="multipart/form-data">
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <div class="formulario col col-12 col-md-6 my-3">
                    ...
                    <div class="my-4">
                        <div class="linha">
                            <input type="text" name="nome" placeholder="Nome do aparelho" value="<?= esc($aparelho['DESCRICAO']) ?>" required>
                            <input type="number" name="consumo" placeholder="Consumo (KWh)" value="<?= esc($aparelho['CONSUMO']) ?>" required>
                            <input type="number" name="tempoUsoMedio" placeholder="Tempo de Uso Médio (Horas)" value="<?= esc($aparelho['TEMPO_DE_USO']) ?>" required>
                        </div>
                        <div class="linha">
                            <select name="ENCE">
                                <option value="<?= esc($aparelho['ENCE']) ?>"><?= esc($aparelho['ENCE']) ?></option>
                            ...
                            <select name="redeEletrica">
                                <option value="<?= esc($redeEletricaAparelho['ID']) ?>" selected><?= esc($redeEletricaAparelho['DESCRICAO']) ?></option>
