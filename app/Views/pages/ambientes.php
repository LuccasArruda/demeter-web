    ...
    <main class="container mx-5">
        <div class="carrossel-cards d-flex overflow-x-scroll position-absolute translate-middle-y ms-5">
            <div class="card ms-5 bg-card" style="width: 23rem;">
                ...
                <div class="card-body">
                    <h5 class="text-verde-primaria text-center">Nome do Ambiente</h5>
                    ...
                    <div class="d-flex justify-content-center w-100 py-2">
                        <a href="" class="text-decoration-none btn-card bg-cor-primaria text-light d-block">Visualizar</a>
